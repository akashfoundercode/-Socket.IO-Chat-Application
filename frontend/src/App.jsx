...
export default function App() {
  ...
  const themes = useMemo(() => ({
    green: {
      ...
      '--theme-primary-hover': '#06b995',
      '--theme-primary-active': '#008069',
      '--theme-primary-text': '#ffffff',
      '--theme-background': '#f4fbf9',
      '--theme-surface': '#ffffff',
      '--theme-surface-secondary': '#f0f4f5',
      '--theme-text': '#111827',
      '--theme-text-secondary': '#667781',
      '--theme-border': '#dfe7e9',
      '--theme-input-bg': '#ffffff',
      '--theme-input-border': '#d1d5db',
      '--theme-input-focus': '#00a884',
      '--theme-icon': '#00a884',
      '--theme-chat-pane': '#efeae2',
      '--theme-chat-bubble': '#d9fdd3',
      '--theme-chat-bubble-text': '#111827',
      '--theme-hover-bg': '#e6f7f2',
      '--theme-hover-text': '#064e3b',
      '--theme-badge': '#dcfce7',
      '--theme-badge-text': '#166534',
      '--theme-danger': '#ef4444',
      ...
      '--wa-green-hover': '#06b995',
      '--wa-online': '#25d366',
      '--wa-soft-bg': '#e6f7f2',
      '--wa-hover-bg': '#e6f7f2',
      '--wa-hover-text': '#064e3b',
      '--wa-chat-bg': '#efeae2',
      '--wa-outgoing-bubble': '#d9fdd3',
      '--wa-accent-light': '#f0fdf4',
      '--wa-accent-border': '#d1fae5',
      '--wa-accent-deep': '#064e3b',
      '--wa-header-gradient': 'linear-gradient(160deg,#0b4d3b 0%,#008069 55%,#00a884 100%)',
      '--wa-theme-badge': '#dcfce7',
      '--wa-theme-badge-text': '#166534'
    },
    orange: {
      ...
      '--theme-primary-text': '#ffffff',
      '--theme-background': '#fffaf5',
      '--theme-surface': '#ffffff',
      '--theme-surface-secondary': '#fff0e1',
      '--theme-text': '#111827',
      '--theme-text-secondary': '#6b7280',
      '--theme-border': '#f1d9c8',
      '--theme-input-bg': '#fff7ed',
      '--theme-input-border': '#fdba74',
      '--theme-input-focus': '#f97316',
      '--theme-icon': '#f97316',
      '--theme-chat-pane': '#fff7ed',
      '--theme-chat-bubble': '#ffedd5',
      '--theme-chat-bubble-text': '#1f2937',
      '--theme-hover-bg': '#fff7ed',
      '--theme-hover-text': '#7c2d12',
      '--theme-badge': '#ffedd5',
      '--theme-badge-text': '#9a3412',
      '--theme-danger': '#ef4444',
      '--theme-success': '#22c55e',
      '--theme-warning': '#f59e0b',
      '--wa-green': '#f97316',
      '--wa-green-dark': '#c2410c',
      '--wa-green-header': '#ea580c',
      '--wa-green-hover': '#fb923c',
      '--wa-online': '#f97316',
      '--wa-soft-bg': '#fff0e1',
      '--wa-hover-bg': '#fff7ed',
      '--wa-hover-text': '#7c2d12',
      '--wa-chat-bg': '#fff7ed',
      '--wa-outgoing-bubble': '#ffedd5',
      '--wa-accent-light': '#fff7ed',
      '--wa-accent-border': '#fed7aa',
      '--wa-accent-deep': '#7c2d12',
      '--wa-header-gradient': 'linear-gradient(160deg,#7c2d12 0%,#ea580c 55%,#f97316 100%)',
      '--wa-theme-badge': '#ffedd5',
      '--wa-theme-badge-text': '#9a3412'
    },
    blue: {
      '--theme-primary': '#168aad',
      '--theme-primary-hover': '#2aa9cf',
      '--theme-primary-active': '#126782',
      '--theme-primary-text': '#ffffff',
      '--theme-background': '#f3f9fc',
      '--theme-surface': '#ffffff',
      '--theme-surface-secondary': '#ebf7fb',
      '--theme-text': '#111827',
      '--theme-text-secondary': '#5b7280',
      '--theme-border': '#d7e6ee',
      '--theme-input-bg': '#f4fbff',
      '--theme-input-border': '#7dd3fc',
      '--theme-input-focus': '#168aad',
      '--theme-icon': '#168aad',
      '--theme-chat-pane': '#edf7fa',
      '--theme-chat-bubble': '#d9f1f8',
      '--theme-chat-bubble-text': '#0f172a',
      '--theme-hover-bg': '#edf7fa',
      '--theme-hover-text': '#164e63',
      '--theme-badge': '#dbeafe',
      ...
      '--theme-warning': '#f59e0b',
      '--wa-green': '#168aad',
      '--wa-green-dark': '#126782',
      '--wa-green-header': '#126782',
      '--wa-green-hover': '#2aa9cf',
      '--wa-online': '#168aad',
      '--wa-soft-bg': '#e4f4f8',
      '--wa-hover-bg': '#edf7fa',
      '--wa-hover-text': '#164e63',
      '--wa-chat-bg': '#edf7fa',
      '--wa-outgoing-bubble': '#d9f1f8',
      '--wa-accent-light': '#f0f9ff',
      '--wa-accent-border': '#bae6fd',
      '--wa-accent-deep': '#164e63',
      '--wa-header-gradient': 'linear-gradient(160deg,#0c4a6e 0%,#126782 55%,#168aad 100%)',
      '--wa-theme-badge': '#dbeafe',
      '--wa-theme-badge-text': '#1e40af'
    },
    purple: {
      ...
      '--theme-surface': '#ffffff',
      '--theme-surface-secondary': '#f3e8ff',
      '--theme-text': '#111827',
      '--theme-text-secondary': '#6b7280',
      '--theme-border': '#ddd6fe',
      '--theme-input-bg': '#f8f5ff',
      '--theme-input-border': '#c4b5fd',
      '--theme-input-focus': '#8b5cf6',
      '--theme-icon': '#8b5cf6',
      '--theme-chat-pane': '#f3e8ff',
      '--theme-chat-bubble': '#e9d5ff',
      '--theme-chat-bubble-text': '#1f2937',
      '--theme-hover-bg': '#f3e8ff',
      '--theme-hover-text': '#4c1d95',
      '--theme-badge': '#ede9fe',
      '--theme-badge-text': '#5b21b6',
      '--theme-danger': '#ef4444',
      '--theme-success': '#22c55e',
      '--theme-warning': '#f59e0b',
      '--wa-green': '#8b5cf6',
      '--wa-green-dark': '#6d28d9',
      '--wa-green-header': '#6d28d9',
      '--wa-green-hover': '#a78bfa',
      '--wa-online': '#8b5cf6',
      '--wa-soft-bg': '#f3e8ff',
      '--wa-hover-bg': '#f3e8ff',
      '--wa-hover-text': '#4c1d95',
      '--wa-chat-bg': '#f3e8ff',
      '--wa-outgoing-bubble': '#e9d5ff',
      '--wa-accent-light': '#faf5ff',
      '--wa-accent-border': '#ddd6fe',
      '--wa-accent-deep': '#4c1d95',
      '--wa-header-gradient': 'linear-gradient(160deg,#4c1d95 0%,#6d28d9 55%,#8b5cf6 100%)',
      '--wa-theme-badge': '#ede9fe',
      '--wa-theme-badge-text': '#5b21b6'
    },
    charcoal: {
      '--theme-primary': '#64748b',
      '--theme-primary-hover': '#7c8da3',
      '--theme-primary-active': '#334155',
      '--theme-primary-text': '#ffffff',
      '--theme-background': '#f6f8fa',
      '--theme-surface': '#ffffff',
      '--theme-surface-secondary': '#eef1f4',
      '--theme-text': '#111827',
      '--theme-text-secondary': '#6b7280',
      '--theme-border': '#d8e0ea',
      '--theme-input-bg': '#f8fafc',
      '--theme-input-border': '#cbd5e1',
      '--theme-input-focus': '#334155',
      '--theme-icon': '#64748b',
      '--theme-chat-pane': '#eef1f4',
      '--theme-chat-bubble': '#e2e8f0',
      '--theme-chat-bubble-text': '#1f2937',
      '--theme-hover-bg': '#eef1f4',
      '--theme-hover-text': '#1e293b',
      '--theme-badge': '#e2e8f0',
      ...
      '--theme-warning': '#f59e0b',
      '--wa-green': '#64748b',
      '--wa-green-dark': '#334155',
      '--wa-green-header': '#334155',
      '--wa-green-hover': '#7c8da3',
      '--wa-online': '#64748b',
      '--wa-soft-bg': '#e8edf2',
      '--wa-hover-bg': '#eef1f4',
      '--wa-hover-text': '#1e293b',
      '--wa-chat-bg': '#eef1f4',
      '--wa-outgoing-bubble': '#e2e8f0',
      '--wa-accent-light': '#f8fafc',
      '--wa-accent-border': '#cbd5e1',
      '--wa-accent-deep': '#1e293b',
      '--wa-header-gradient': 'linear-gradient(160deg,#0f172a 0%,#334155 55%,#64748b 100%)',
      '--wa-theme-badge': '#e2e8f0',
      '--wa-theme-badge-text': '#334155'
    }
  }), []);
  ...
  // Mobile Browser Back Button Interceptor & Root Exit Confirmation
  const {
    showExitConfirm,
    handleConfirmExit,
    handleCancelExit,
